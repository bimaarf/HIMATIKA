...
@section('content')
    ...
    <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
      ...
      <div class="container-fluid">
        ...
        <!-- Search form -->
        <form class="d-none d-md-flex input-group w-auto my-auto"action="{{route('admin.pending.dashboard')}}">
              ...
              <!-- Search form -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <a href="{{route('admin.pending.detail',['key'=>$brt->key])}}" class="btn btn-sm btn-info"><div class="bi icon dripicons-view-list"></div>Lihat</a>
                    <a href="{{route('admin.pending.formUbah',['key'=>$brt->key])}}" class="btn btn-sm btn-warning"><div class="bi icon dripicons-pencil"></div>Edit</a>
                    <a href="{{route('admin.pending.hapus',['id'=>$brt->id])}}" class=" btn btn-sm btn-danger" data-toggle="tooltip"><div class="bi icon dripicons-trash"></div>Hapus</a>
