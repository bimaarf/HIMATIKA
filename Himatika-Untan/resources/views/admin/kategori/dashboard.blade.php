              ...
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <a href="{{route('admin.kategori.detail',[ 'id'=>$brt->id])}}" class="btn btn-sm btn-info"><div class="bi icon dripicons-view-list"></div>Lihat</a>
                    <a href="{{route('admin.kategori.formUbah',['id'=>$brt->id])}}" class="btn btn-sm btn-warning"><div class="bi icon dripicons-pencil"></div>Edit</a>
